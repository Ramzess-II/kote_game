...
#define    MAX_TIME      30000        // максимальное время игры 3000
#define    MIN_TIME      20000         // минимальное время игры  600
#define    MAX_REPLEY    12          // допустимое количество реплеев (не ставить кратно 10!)

#define    MAX_PWM       600         // максимальный ШИМ движков
#define    MIN_PWM       400         // минимальный ШИМ движков
...
#define    MAX_ROUND     30          // если уперлись в стену и вращаемся
